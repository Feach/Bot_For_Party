...
from keyboards.client_keyboards import keyboards_create_gender, button_next, button_next12, button_category, button_location, button_choice, ikb_start
...
async def proverka_party(message: types.Message):
    ...
    if is_user_exists:
        ...
        await message.bot.send_message(message.from_user.id, '<b>ОШИБКА! Не создан профиль! Для создания пати нужно иметь профиль</b>',
